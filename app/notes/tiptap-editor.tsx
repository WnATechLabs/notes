...
type Props = { mode: 'create' } | { mode: 'edit'; noteId: string; initialContent: string };
...
export default function TiptapEditor(props: Props) {
  ...
  const [createState, formAction, isPending] = useActionState(createNote, {} as CreateNoteState);

  ...
  return (
    <div className='flex min-h-screen flex-col items-center px-4 py-20'>
      ...
      <p className='mt-3 max-w-md text-center text-lg text-foreground/50'>
        A fast, minimalistic place to capture your thoughts. Rich text editing, instant save, and
        one-click sharing.
      </p>
      ...
      <section className='mt-20 w-full max-w-3xl'>
        <div className='grid gap-6 sm:grid-cols-3'>
          {[
            ...
            <div key={feature.title} className='rounded-xl border border-foreground/10 p-5'>
